...
// Force load RTL text plugin inside the core component
...
function MapMarker({
  ...
  const marker = useMemo(() => {
    ...
    const handleMouseEnter = (e) => {
      // Elevate z-index natively on the marker to prevent overlap issues
      markerInstance.getElement().style.zIndex = '50';
      callbacksRef.current.onMouseEnter?.(e);
    };
    const handleMouseLeave = (e) => {
      markerInstance.getElement().style.zIndex = '';
